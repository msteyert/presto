...
def writeCsvFile(outputFile, values):
    ...
    writeLine("Spacer sequence", values["spacer"], "Spacer matches on", values["spacerMatchesOn"])
    writeLine()
    ...
    writeLine("Autogenerated" if True else "User-defined")  # TODO Say whether user-defined or autogenerated
